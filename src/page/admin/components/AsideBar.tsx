            ...
            <div className="overflow-y-auto py-4 px-3 bg-textColor min-h-screen rounded dark:bg-gray-800">
                <ul className="space-y-2">
                    ...
                    <select id="countries"
                        ...
                        <option selected={undefined}>Utilisateurs</option>
                        <option value="liste">Liste</option>
                        <option value="formation">Formations</option>
                    </select>
                    <li>
                        <a href="#"
                           className="flex items-center p-2 text-white font-normal text-gray-900 rounded-lg dark:text-white hover:bg-primaryColor dark:hover:bg-gray-700">
                            <svg
                    ...
                    <li>
                        <a href="#"
                           className="flex items-center p-2 text-white font-normal text-gray-900 rounded-lg dark:text-white hover:bg-primaryColor dark:hover:bg-primaryColor">
                            <svg
                                className="flex-shrink-0 w-6 h-6 text-white transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-primaryColor"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
